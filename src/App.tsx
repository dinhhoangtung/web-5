...
const MOCK_DATA = [
  ...
  {
    id: 3,
    title: "Sử dụng hệ thống Microsoft Azure thay cho Microsoft Imagine (DreamSpark) cũ",
...
const MOCK_DATA_2= [
  {
    id: 1,
    title: "Dịch vụ DNS 1.1.1.1 mới của Cloudflare, bảo mật hơn, lướt web nhanh hơn",
    link: "https://phongdl.uit.edu.vn/su-dung-openvpn",
    date: "18-07-2021",
  },
  {
  ...
  {
    id: 3,
    title: "Microsoft công bố ra mắt bản Windows 10 Anniversary Update vào ngày 2/8",
    link: "https://phongdl.uit.edu.vn/su-dung-he-thong-microsoft-azure-thay-cho-microsoft-imagine-dreamspark-cu",
    date: "18-07-2021",
  },
  {
  ...
  return (
    ...
    <div className="">
     ...
     <div className="flex gap-5">
        {/* left col */}
     <div className="w-[288px] h-auto flex flex-col gap-5">
